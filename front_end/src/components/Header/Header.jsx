...
export default function PrimarySearchAppBar() {
  ...
  const { carts, isAuthenticated, profile, setIsAuthenticated } =
  ...
  const renderMenu = (
    ...
    >
      ...
      <Link to="/admin">
        <MenuItem onClick={handleMenuClose}>Trang quản lý</MenuItem>
      </Link>
    </Menu>
  );
    ...
    >
      <Link to="/cart">
        <MenuItem>
          ...
          >
            <Badge
              badgeContent={isAuthenticated ? carts?.length || "0" : null}
              color="error"
            >
              <BsFillCartCheckFill />
            </Badge>
...
img-fluid" src="https://invietnhat.vn/wp-content/uploads/2023/08/logo-shop-thoi-trang-nu-6.jpg" alt="logo Đức Thoại Store" width="180" height="90" style={{ marginTop: "12px" }} />
            ...
            <Box sx={{ display: { xs: "none", md: "flex" }, gap: "10px" }}>
              ...
              >
                ...
                >
                  <BsFillCartCheckFill />
                </Badge><div style={{fontSize:'15px'}}>Giỏ hàng</div>
              </IconButton>
              ...
              {isAuthenticated ? (
                <Box sx={{ flexGrow: 0, display: "flex" }}>
                  <Tooltip title={profile?.name}>
                    <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                      <Avatar
                        alt="Remy Sharp"
                        src={BASE_URL_IMAGE + profile?.avatar}
                      />
                    </IconButton>
                  </Tooltip>
                  <Menu
                ...
                >
                  ...
                  <Typography component="p" style={{fontSize:'15px'}}>Đăng nhập / Đăng ký</Typography>
                </Link>
              )}
            </Box>
